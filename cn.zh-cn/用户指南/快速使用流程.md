# 快速使用流程<a name="ZH-CN_TOPIC_0146116336"></a>
...
<td class="cellrowborder" valign="top" width="26.162616261626166%" headers="mcps1.2.4.1.2 "><p id="p8688549161510"><a name="p8688549161510"></a><a name="p8688549161510"></a><a href="zh-cn_topic_0143271182.md">步骤一：添加数据库并开启审计</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="26.162616261626166%" headers="mcps1.2.4.1.2 "><p id="p683214301554"><a name="p683214301554"></a><a name="p683214301554"></a><a href="Linux操作系统.md">安装Agent</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="26.162616261626166%" headers="mcps1.2.4.1.2 "><p id="p42141467511"><a name="p42141467511"></a><a name="p42141467511"></a><a href="zh-cn_topic_0145057229.md">查看审计结果</a></p>
</td>
...
<div class="notice" id="note1530212365596"><a name="note1530212365596"></a><a name="note1530212365596"></a><span class="noticetitle"> 须知： </span><div class="noticebody"><p id="p4302183635911"><a name="p4302183635911"></a><a name="p4302183635911"></a>您可以根据业务需求设置数据库审计规则。有关配置审计规则的详细操作，请参见<a href="zh-cn_topic_0145057225.md">配置审计规则</a>。</p>
</div></div>
</td>
</tr>
</tbody>
...
-   如果审计功能无法正常使用，请参照[无法使用数据库安全审计](zh-cn_topic_0143651392.md)章节进行处理。
