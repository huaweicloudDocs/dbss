...
3.  查看实例的“基本信息“、“网络配置信息“和“关联数据库“，如[图2](#fig1428710201627)所示，相关参数说明如[表1](#table14411073418)所示。
    ...
    **表 1**  实例概览信息参数说明
    ...
    <td class="cellrowborder" valign="top" width="64.95%" headers="mcps1.2.4.1.3 "><p id="p17413871046"><a name="p17413871046"></a><a name="p17413871046"></a>实例的名称。单击名称后的<a name="image197001154121219"></a><a name="image197001154121219"></a><span><img id="image197001154121219" src="figures/编辑-56.png"></span>，可以修改实例名称。</p>
    </td>
    </tr>
    ...
    <a name="ul44136710415"></a><a name="ul44136710415"></a><ul id="ul44136710415"><li>运行中</li><li>创建中</li><li>故障</li><li>已关闭</li><li>已冻结</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" headers="mcps1.2.4.1.2 "><p id="p64131575419"><a name="p64131575419"></a><a name="p64131575419"></a>实例的备注信息。单击备注后的<a name="image4306398137"></a><a name="image4306398137"></a><span><img id="image4306398137" src="figures/编辑-57.png"></span>，可以修改备注信息。</p>
    </td>
    </tr>
