# 管理备份的审计日志<a name="ZH-CN_TOPIC_0145247771"></a>
...
2.  进入备份日志列表入口，如[图1](#zh-cn_topic_0145057228_fig10560192191214)所示。

    **图 1**  进入备份日志列表入口<a name="zh-cn_topic_0145057228_fig10560192191214"></a>  
...
3.  查看备份的审计日志信息，如[图2](#fig114613221242)所示，相关参数说明如[表1](#table964761214306)所示。
    ...
    **图 2**  查看备份审计日志信息<a name="fig114613221242"></a>  
    ...
    在列表右上方单击![](figures/日历-64.png)，选择开始时间和结束时间，可以查看指定的时间段的备份日志。
