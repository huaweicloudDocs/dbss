...
4.  单击“确定“，Agent添加成功。
5.  单击数据库左侧的![](figures/下载详情-30.png)展开该数据库的详细信息，查看添加的Agent信息，如[图4](#fig18975172124811)所示。
...
4.  单击“确定“，Agent添加成功。
5.  单击数据库左侧的![](figures/下载详情-31.png)展开该数据库的详细信息，查看添加的Agent信息，如[图8](#fig1470611221310)所示。

    **图 8**  Agent添加完成<a name="fig1470611221310"></a>  
    ![](figures/Agent添加完成-32.png "Agent添加完成-32")
...
Agent添加完成后，您还需要根据Agent的添加方式在数据库端或应用端安装Agent，将添加的数据库连接到数据库安全审计实例，数据库安全审计才能对添加的数据库进行审计。有关安装Agent的详细操作，请参见[Linux操作系统](Linux操作系统.md)。
