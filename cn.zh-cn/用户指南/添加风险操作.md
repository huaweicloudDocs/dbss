...
数据库安全审计还默认提供一条“数据库拖库检测“的风险操作，可以对成功连接数据库安全审计的所有数据库进行风险操作审计。该风险操作规则默认开启，您可根据业务实际情况进行设置“基本信息“、“客户端IP/IP段“、“操作类型“、“操作对象“、“执行结果“。
