...
5.  查看DBSS实例的信息，如[图1](#fig1325745611915)所示，相关参数说明如[表1](#table1025994517211)所示。
...
7.  在弹出的提示对话框中，单击“确定“，如[图3](#fig97781991740)所示。

    **图 3** “重启“对话框<a name="fig97781991740"></a>  
    ![](figures/重启对话框.png "重启对话框")

    单击实例列表右上方的![](figures/刷新界面.png)刷新界面，实例重启成功。
...
4.  在左侧导航树中，选择“数据库安全服务  \>  数据库安全防护“，进入数据库安全防护实例列表界面。
5.  单击需要开启的DBSS实例。
6.  在需要开启的实例所在行，单击“开启“，如[图4](#fig14477185813019)所示。
...
4.  在左侧导航树中，选择“数据库安全服务  \>  数据库安全防护“，进入数据库安全防护实例列表界面。
5.  单击需要关闭的DBSS实例。
6.  在需要关闭的实例所在行，单击“关闭“，如[图5](#fig17998195641819)所示。

    **图 5**  关闭实例<a name="fig17998195641819"></a>  
    ![](figures/关闭实例.png "关闭实例")

7.  在弹出的提示对话框中，单击“确定“，如[图6](#fig3772102813313)所示。
