...
3.  在弹出的对话框中，设置数据库的信息，如[图2](#fig1433184615414)所示，相关参数说明如[表1](#table4295843716304)所示。
    ...
    **表 1**  数据库参数说明
    ...
    <td class="cellrowborder" valign="top" width="60.980000000000004%" headers="mcps1.2.4.1.2 "><p id="p540672120518"><a name="p540672120518"></a><a name="p540672120518"></a>添加的数据库运行的操作系统。您可以选择LINUX64。</p>
    </td>
