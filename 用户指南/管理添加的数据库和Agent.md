...
5.  查看数据库信息，如[图1](#fig315603514243)所示，相关参数说明如[表1](#table4295843716304)所示。

    **图 1**  查看数据库和Agent信息<a name="fig315603514243"></a>  
    ...
    **表 1**  数据库信息参数说明
    ...
    <td class="cellrowborder" valign="top" width="18%" headers="mcps1.2.4.1.3 "><p id="p2145418161020"><a name="p2145418161020"></a><a name="p2145418161020"></a>192.168.0.104</p>
...
5.  单击数据库左侧的![](figures/icon-drop.png)展开Agent的详细信息，如[图2](#fig1280134145116)所示，相关参数说明如[表2](#table146922503232)所示。

    **图 2**  查看数据库和Agent信息<a name="fig1280134145116"></a>  
    ![](figures/查看数据库和Agent信息.png "查看数据库和Agent信息")
    ...
    **表 2**  Agent参数说明
    ...
    <tr id="row15489185119318"><td class="cellrowborder" valign="top" width="25.61%" headers="mcps1.2.3.1.1 "><p id="p648985110317"><a name="p648985110317"></a><a name="p648985110317"></a>SHA256校验值</p>
    </td>
    <td class="cellrowborder" valign="top" width="74.39%" headers="mcps1.2.3.1.2 "><p id="p62511221845"><a name="p62511221845"></a><a name="p62511221845"></a>Agent安装包的校验值。</p>
    </td>
    </tr>
