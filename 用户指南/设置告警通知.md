...
3.  设置告警通知，如[图2](#fig139441652133611)所示，相关参数说明如[表1](#table29461252153613)所示。
    ...
    **表 1**  告警通知参数说明
    ...
    <a name="ul29616502620"></a><a name="ul29616502620"></a><ul id="ul29616502620"><li><a name="image1935182993015"></a><a name="image1935182993015"></a><span><img id="image1935182993015" src="figures/icon-open.png"></span>：开启</li><li><a name="image8404155610300"></a><a name="image8404155610300"></a><span><img id="image8404155610300" src="figures/icon-close.png"></span>：关闭</li></ul>
    </td>
    <td class="cellrowborder" valign="top" width="18%" headers="mcps1.2.4.1.3 "><p id="p1031714171566"><a name="p1031714171566"></a><a name="p1031714171566"></a><a name="image15241172463116"></a><a name="image15241172463116"></a><span><img id="image15241172463116" src="figures/icon-open.png"></span></p>
    </td>
    </tr>
