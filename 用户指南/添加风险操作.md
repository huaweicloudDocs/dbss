...
3.  在“添加风险操作“界面，设置基本信息和客户端IP地址，如[图2](#fig161016109141)所示，相关参数说明如[表1](#table4295843716304)所示。
    ...
    **表 1**  风险操作参数说明
    ...
    <td class="cellrowborder" valign="top" width="18%" headers="mcps1.2.4.1.3 "><p id="p1215616575236"><a name="p1215616575236"></a><a name="p1215616575236"></a><a name="image109521428162418"></a><a name="image109521428162418"></a><span><img id="image109521428162418" src="figures/icon-open.png"></span></p>
    </td>
    </tr>
